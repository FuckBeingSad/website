...
var consoleLine = new Typed('#user-line', {
    strings: ['<span>sudo apt-get install <em>fbs_members</em>'],
    typeSpeed: 0,
    backSpeed: 0,
    cursorChar: '|',
    onComplete: function () {
        ...
        var consoleLine = new Typed('#console-line', {
            strings: ['<span>Reading package lists... Done<br>Building dependency tree<br>Reading state information... Done<br>Calculating <em>fbs_members</em>... Done'],
            typeSpeed: 0,
            backSpeed: 0,
            cursorChar: '',
            onComplete: function () {
                ...
                var consoleLine = new Typed('#user-line2', {
                    ...
                    onComplete: function () {
                        ...
                        var consoleLine = new Typed('#user-line3', {
                            strings: ['<span>tree /<em>fbs_members</em>'],
                            typeSpeed: 0,
                            backSpeed: 0,
                            cursorChar: '|',
                            onComplete: function () {
                                ...
                                var consoleLine = new Typed('#console-line2', {
                                    ...
                                    onComplete: function () {
                                        ...
                                        $('span.vops-item').on('click', function () {
                                            window.open("https://twitter.com/vopswtf");
                                        });

                                        $('span.twitter').on('click', function () {
                                            window.open("https://twitter.com/fbscollective");
                                        });

                                        $('span.tiktok').on('click', function () {
